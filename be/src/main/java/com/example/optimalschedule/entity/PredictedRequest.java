...
@NamedNativeQuery(name = "getAllPredictedByAccountId", query = "select r.id as routeOrRequestId, r.address_start as addressStart, " +
        ...
        "order by r.status_id asc, r.booking_date desc", resultSetMapping = "prMapping")

@Entity
@Data
@NoArgsConstructor
@Table(name = "predicted_request")
public class PredictedRequest {
    ...
    public PredictedRequest(int passengerId, Double pickUpTime, int capacity, Double cost, Double latOrigin,
    ...
    public PredictedRequest(int id, int passengerId, Double pickUpTime, int capacity, Double cost, Double latOrigin,
                            Double lngOrigin, Double latDestination, Double lngDestination, int statusId, int groupId,
